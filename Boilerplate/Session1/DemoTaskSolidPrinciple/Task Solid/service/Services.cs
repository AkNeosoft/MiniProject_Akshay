using Task_Solid.Interface;
using Task_Solid.Models;

namespace Task_Solid.service
{   /// <summary>
/// Class Services inherit from IServices, IAdd, IDelete, IUpdate, IGetAllUser 
/// </summary>
    public class Services: IServices, IAdd, IDelete, IUpdate, IGetAllUser
    {
